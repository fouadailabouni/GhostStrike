"""
GhostStrike AI Engine — Blue Team Agent
...
class BlueTeamAgent(GhostStrikeAgent):
    """
    Defensive security agent.
    Audits, hardens, and monitors systems without disrupting availability.
    Generates detection rules and incident response playbooks.
    """

    name        = "Blue Team Agent"
    description = "Defensive security agent. System auditing, hardening, log analysis, threat detection."
    prompt_file = "blue_team_prompt.md"
